-----------------------------------------------------------------------
-- SQL AGENT JOBS — TROUBLESHOOTING & MONITORING
-- Purpose : Monitor running jobs, review schedules, investigate
--           failures, and analyze job duration history.
-- Safety  : All queries are read-only (except where noted).
...
-----------------------------------------------------------------------
-- SECTION 1: CURRENTLY RUNNING JOBS
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- SECTION 2: JOB CONFIGURATION & DETAILS
-----------------------------------------------------------------------

-- Get comprehensive job information with categories, owners, and schedules
SELECT
    sj.name AS [Job Name],
...
-- Comprehensive report of all SQL Agent jobs and their schedules
SELECT
    [JobName] = [jobs].[name],
...
-- Alternative detailed job schedule view
-- (Shows jobs with schedules including those not yet run)
USE msdb;
GO
